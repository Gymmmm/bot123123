...
# httpx logs full Telegram Bot API URLs at INFO level, which include the token.
# Keep application logs useful without persisting credentials.
...
# 用户流程运行约束
DEFAULT_TIMEZONE = os.getenv("DEFAULT_TIMEZONE", "Asia/Phnom_Penh")
LISTING_ACTIVE_STATUS = "active"
LISTING_PENDING_STATUS = "pending"
LISTING_RESERVED_STATUS = "reserved"
LISTING_RENTED_STATUS = "rented"
