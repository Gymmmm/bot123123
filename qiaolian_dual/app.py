...
def build_application(*, token: str | None = None) -> Application:
    from .admin_commands import cmd_deal_done, cmd_lead_response, cmd_push_all, cmd_push_local
    ...
    async def post_init(application: Application) -> None:
        ...
        admin_commands = user_commands + [BotCommand('admin_list', '管理员管理')]
