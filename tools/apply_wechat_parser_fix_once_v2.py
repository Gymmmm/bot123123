...
for rel in (
    ".github/workflows/apply-wechat-parser-fix-once.yml",
    "tools/apply_wechat_parser_fix_once.py",
    "tools/apply_wechat_parser_fix_once_v2.py",
):
