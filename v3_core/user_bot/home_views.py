...
WELCOME_TEXT = (
    "🏠 <b>侨联地产｜金边华人房产服务</b>\n\n"
    "真实房源 · 实拍更新\n"
    "找房、看房、签约到入住后的住房问题，都可以从这里处理。\n\n"
    "从频道具体房源进入时，系统会自动带上房源信息，不用重复说明。\n\n"
    "👇 请选择您现在要做的事"
)
...
def build_contact_view(*, advisor_url: str = "") -> HomeView:
    ...
    first = HomeChoice("💬 打开顾问对话", "contact", url=clean_advisor) if clean_advisor else HomeChoice("💬 联系顾问", "contact")
    return HomeView(
        kind="contact",
        text=CONTACT_TEXT,
        rows=(
