...
extracted V3 repositories so an admin UI can review canonical inventory, build
a frozen package from the original source media, approve that package, and then
hand it to the delivery boundary.
"""
