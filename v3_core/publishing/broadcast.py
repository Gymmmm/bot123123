...
TEMPLATES: Mapping[str, tuple[str, str]] = {
    "weekly": (
        ...
        "这周要找房或换房？直接发我：\n"
        "<b>区域 + 月预算 + 户型 + 入住时间</b>\n\n"
        "比如：BKK1｜2房｜$800以内｜月底入住\n\n"
        "条件清楚了，我按现有在租帮你筛，不用自己翻一堆。\n\n"
        "<b>💎 侨联地产｜金边自己人</b>",
    ),
    "weekend": (
        "🏠 周末看房",
        "<b>🏠 周末看房安排</b>\n\n"
        "周末想集中看房？先把 <b>区域、预算、户型、方便时间</b> 发我。\n\n"
        "我先确认能不能看，再帮你约；人不方便到场，视频看房也行。\n\n"
        "<b>💎 侨联地产｜金边自己人</b>",
    ),
    "viewing": (
        "📋 看房前准备",
    ...
    "contract": (
        "📝 签约提醒",
        "<b>📝 签约前再核一遍</b>\n\n"
        "租期、押付、水电、物业、网络、停车，还有提前退租和维修责任——这些最好签字前都谈清楚。\n\n"
        "入住当天把房屋现状、家具家电、表数、钥匙门卡拍好留底，以后省心。\n\n"
        "<b>💎 侨联地产｜金边自己人</b>",
    ),
}
...
_FALLBACK_WEATHER_TEXT = {
    "storm": "今天有雷雨，出门先看看路况；看房时间对不上，跟顾问说一声改一下就行。",
    "rain_heavy": "今天雨比较大，出门看房多留点路上时间。",
    "rain_light": "今天有阵雨，出门记得带伞。",
    "rain_possible": "今天午后可能下雨，看房尽量错开那段。",
    "hot": "今天挺热，看房尽量别卡在中午。",
    "sunny": "今天太阳大，出门晒得慌的话注意防晒。",
    "humid": "今天闷热，室内看房还好，出门路上记得补水。",
    "good": "今天天气不错，适合出门看房或办点事。",
    "stable": "今天天气还行，没什么特别要盯的。",
}
