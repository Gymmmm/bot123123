...
_MARKET_LOCATIONS_EXPLICIT: tuple[MarketLocation, ...] = (
    ...
    MarketLocation("金界", "金界", "nearby", ("金界", "naga", "naga world")),
    ...
    MarketLocation("富力城", "富力城", "project_market", ("富力城", "富力中心城", "富力小区", "富力", "r&f city", "rf city", "r f city", "金边中心城")),
...
PROJECT_IDENTITIES: tuple[ProjectIdentity, ...] = (
    ...
    ProjectIdentity(
        ...
        "富力城",
        "project",
        ("富力城", "富力中心城", "富力小区", "富力", "富力b11", "r&f city", "rf city"),
        property_family="公寓",
    ),
    ProjectIdentity(
        "shangri_la",
        "香格里拉",
        "project",
        ("香格里拉", "香格里拉the peak", "the peak", "shangri-la", "shangri la"),
        property_family="公寓",
    ),
    ProjectIdentity(
        "alesia",
    ...
    ProjectIdentity(
        ...
        "太子寰宇",
        "project",
        ("金边太子寰宇", "太子寰宇", "寰宇中心", "寰宇", "prince universe"),
        property_family="公寓",
    ),
    ProjectIdentity(
        "agile",
    ...
    ProjectIdentity(
        ...
        "Morgen Tower",
        "project",
        ("morgen tower", "morgern tower", "morgen"),
        property_family="公寓",
    ),
    ProjectIdentity(
        "prince_international",
        "太子国际广场",
        "project",
        ("太子国际广场", "太子国际", "prince international"),
        property_family="公寓",
    ),
    ProjectIdentity(
        "capital_guojin",
...
PROPERTY_RULES: tuple[PropertyRule, ...] = (
    ...
    PropertyRule("别墅", "独栋别墅", "独栋别墅", ("独栋别墅", "泳池独栋", "独栋", "sky villa", "villa", "别墅")),
