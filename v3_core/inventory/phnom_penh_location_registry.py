...
MARKET_LOCATIONS: tuple[MarketLocationRecord, ...] = (
    ...
    MarketLocationRecord("金界", "金界附近", "nearby", ("金界", "金界附近", "naga", "naga world", "nagaworld")),
    ...
    MarketLocationRecord("机场附近", "机场附近", "nearby", ("机场附近", "机场路", "老机场", "旧机场")),
...
PROJECT_IDENTITIES: tuple[ProjectRegistryEntry, ...] = (
    ProjectRegistryEntry(
        "agile_sky", "雅居乐",
        ("雅居乐", "雅居乐公寓", "Agile", "Agile Sky", "Agile Sky Residence"),
    ...
    ProjectRegistryEntry(
        "rf_city", "富力城",
        ("富力城", "富力中心城", "R&F City", "R&F", "RF City", "R F City", "金边中心城"),
    ...
    ProjectRegistryEntry("rose_apple", "玫瑰滨江园", ("玫瑰滨江园", "玫瑰滨江", "Rose Apple"), project_name_en="Rose Apple", property_family="公寓"),
    ProjectRegistryEntry("prince_happiness", "太子幸福广场", ("太子幸福", "太子幸福广场", "幸福广场", "The Pinnacle", "Prince Happiness Plaza"), project_name_en="The Pinnacle", property_family="公寓"),
    ProjectRegistryEntry("prince_international", "太子国际广场", ("太子国际", "太子国际广场"), property_family="公寓"),
    ProjectRegistryEntry("prince_huan_yu", "太子寰宇", ("太子寰宇",), property_family="公寓"),
    ProjectRegistryEntry("prince_modern", "太子现代广场", ("太子现代广场",), property_family="公寓"),
    ProjectRegistryEntry("prince_central", "太子中央广场", ("太子中央广场",), property_family="公寓"),
    ProjectRegistryEntry("wealth_mansion", "财富大厦", ("财富大厦", "Wealth Mansion"), project_name_en="Wealth Mansion", property_family="公寓"),
    ProjectRegistryEntry("capital_gold", "首都国金", ("首都国金",), property_family="公寓"),
    ProjectRegistryEntry("royal_one", "皇家一号", ("皇家一号", "Royal One"), project_name_en="Royal One", property_family="公寓"),
    ProjectRegistryEntry("picasso", "毕加索", ("毕加索", "Picasso"), project_name_en="Picasso", property_family="公寓"),
    ProjectRegistryEntry("morgan", "摩根", ("摩根", "Morgan"), project_name_en="Morgan", property_family="公寓"),
    ProjectRegistryEntry("the_gateway", "The Gateway", ("The Gateway", "Gateway"), project_name_en="The Gateway", property_family="公寓"),
    ProjectRegistryEntry("urban_village", "Urban Village", ("Urban Village",), project_name_en="Urban Village", property_family="公寓"),
...
__all__ = [
    ...
    "clean_registry_text", "project_by_key", "project_search_terms", "projects_in_text",
