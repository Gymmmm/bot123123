...
from qiaolian_lib.runtime_paths import load_project_dotenv, project_root_dir
from renderers.cover import CoverGenerator

ROOT_DIR = project_root_dir(__file__)
...
CORNER_LOGO_PATH = os.getenv(
    "CORNER_LOGO_PATH",
    str((ROOT_DIR / "assets" / "brand" / "qiaolian_corner_mark_120x40.png").resolve()),
)
