...
def channel_profile_text() -> str:
    """频道简介文案（填写在 Telegram 频道 About 栏）。"""
    return (
        "🏠 金边租房精选 · 侨联地产\n"
        "每条帖子都有实拍图、真实报价、费用说明\n"
        "📍 富力城 · 炳发城 · BKK · 钻石岛\n"
...
def channel_pinned_post_text() -> str:
    """频道置顶帖文案（首次发布时置顶）。"""
    from .config import ADVISOR_TG, CHANNEL_URL
    return (
        "#置顶 #金边租房\n"
        "\n"
        "👋 <b>欢迎来到侨联地产 · 金边租房频道</b>\n"
        ...
        "\n"
        "<b>怎么找房？</b>\n"
        "1️⃣ 直接浏览帖子，看到心仪的点「预约看房」\n"
        "2️⃣ 想先咨询，点「咨询这套」联系顾问\n"
        "3️⃣ 有具体需求，直接 DM 我们的顾问\n"
        "\n"
        f"📱 顾问直接联系：{ADVISOR_TG or '@pengqingw'}\n"
        f"📢 频道地址：{CHANNEL_URL or 't.me/qiaolianzufang'}\n"
        "\n"
        "━━━━━━━━━━━━\n"
        "我们公司在金边有多年租房服务经验，"
        "老客户口碑传播是我们最大的信任来源。\n"
