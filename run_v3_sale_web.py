...
This branch does not wire the service into production. When enabled later it
serves the shared V3 sale inventory without changing sale publication policy.
"""
